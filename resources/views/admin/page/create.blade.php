                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('admin.manage-page.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="page_kategori" id="page_kategori" value="{{ old('page_kategori') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        </div>
                        <div class="mb-4">
