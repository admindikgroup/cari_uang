                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.faq.update', $faq->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="question" id="question" value="{{ $faq->question }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
                        <div class="mb-4">
                            <label for="answer" class="block text-gray-700 text-sm font-bold mb-2">Answer:</label>
                            <textarea name="answer" id="answer" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ $faq->answer }}</textarea>
                        </div>
